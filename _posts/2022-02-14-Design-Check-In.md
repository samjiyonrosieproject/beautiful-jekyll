...
#### Design 3:
![]
This design sketch attempts to address eating together in the cafeteria, sitting together in the library, being engaged and present with fellow students, and being less judgemental of other grades. Behind all of these tasks is a single unifying factor; increasing social interactions across grades is the key to accomplishing all four of these tasks. The sketch shows a student using an app/website that allows students in the Upper Division to sign up for different activities in common social areas across campus, namely Katz Library and the cafeteria. Under the cafeteria tab on the app, we envision having sign-ups for table seating, with a limited number of spots at each table per grade. Under the Katz Library tab, there would be a dropdown list of various activities like study groups and leisure activities for students from different grades to mix and socialize. Again, the goal here is to limit spots per grade so that we can maximize grade diversity. The design addresses the first task by essentially enforcing grade diversity in the cafeteria and library, accomplishing the goal of having people eat and sit together. The activity sign-up feature helps students remain more engaged with each other while bonding over a shared task. The last task of being less judgemental is the most difficult task to accomplish with any design, but the hope is that increasing social interactions between students of different grades will create friendships and thus decrease resentment as a general trend.
